...
class DailyReport < ApplicationRecord
  ...
  validates :reported_on, presence: true, uniqueness: { scope: :pet_id }
  ...
  private
    # Photos of pets: only real image types, capped in size — see the upload-validation judgment call in the README.
