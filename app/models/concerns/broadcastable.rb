...
# Pushes a Turbo page refresh to everyone watching the pet's page whenever the record changes.
#
# A refresh carries no data: subscribers re-request the page through the authorized controller, so nothing about a
# pet is written to the cable. Only pages that already passed Pundit render the signed stream name.
#
